...
export default function TopMovies() {
  ...
  return (
    <div className="mb-10">
      <div className="mb-5">
        <h2 className="text-2xl font-bold text-[#1e2227] max-[980px]:text-xl">Top Movies</h2>
        <p className="text-sm text-gray-400 mt-1 max-[980px]:text-xs">Enjoy our highest rated films.</p>
      </div>
      {loading ? (
